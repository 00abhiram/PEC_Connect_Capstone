...
# Only show features if logged in
if "user" in st.session_state:
    st.info("✅ You are logged in! Use the **Sidebar Menu** (left) to access Notes, Bot, and Mentorship.")
else:
    st.warning("⚠️ Please **Login** or **Signup** in the sidebar to access Notes and Mentorship.")